...
/* WEBPACK VAR INJECTION */(function($) {$(document).keydown(function (event) {
...
function loading() {
	var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Cargando datos';

	if ($('.load').children().length == 0) {
		$('.load').append('<div class=\'load-animation\'>\n\t\t\t\t<div class=\'text-center loading\'>\n\t\t\t\t\t<img src=\'/img/load.gif\' alt=\'' + text + '\' style=\'width: 100px\'>\n\t\t\t\t\t<h4>' + text + '</h4>\n\t\t\t\t</div>\n\t\t\t</div>');
	}
}
